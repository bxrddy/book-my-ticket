...
<!--             <li><a href="add_users.php"><i class="fa fa-circle-o"></i> Add new user</a></li> -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa fa-user la-lg"></i>&nbsp; All Users
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa fa-user"></i> All Users</a></li>
      </ol>
    </section>
      ...
      ?>
          ...
          <div class="col-md-3">
            <div class="box box-widget widget-user">
                <!-- Add bg color to the header using any of the bg-* classes -->
                <div class="widget-user-header">
                  <div class="row">

                    <div class="col-sm-6">
                      <h3 class="widget-user-username" style="font-weight: 500"><?php echo $name; ?></h3>     
                    </div>

                    <div class="col-sm-6" align="right">
                      <h4 class="widget-user-username">Balance</h4>
                      <h3 class="widget-user-desc" style="margin-top: 7px;">$<?php echo $balance; ?></h3>
                    </div>
